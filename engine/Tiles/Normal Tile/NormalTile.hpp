...
#include  "engineFramework/Tiles/Tile.hpp"
#include <sstream>
#include <string>
...
public:
    NormalTile(short type, int x, int y, float gridsize_f, sf::Texture& texture, const sf::IntRect& texturerect, bool collision_enabled = false);
    virtual ~NormalTile();
