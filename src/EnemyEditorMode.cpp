...
void EnemyEditorMode::updateGUI(const float& dt)
{
    ...
    this->select_Rect.setPosition(sf::Vector2f(this->editorstatedata->mouseposGridI->x * this->statedata->gridSize.x, this->editorstatedata->mouseposGridI->y * this->statedata->gridSize.y));
...
void EnemyEditorMode::inittext()
{
    ...
    // this->controls = new sf::Text(*this->editorstatedata->font);
    this->cursortext->setFillColor(sf::Color::White);
    this->cursortext->setCharacterSize(GUI::calcCharSize(vm, 140));
    this->cursortext->setOutlineThickness(1.f);
    this->cursortext->setPosition(sf::Vector2f(GUI::pixelpercentX(78.4, vm), GUI::pixelpercentX(3, vm)));
    ...
    this->controls->setPosition(sf::Vector2f(GUI::pixelpercentX(78.4, vm), GUI::pixelpercentY(33, vm)));
