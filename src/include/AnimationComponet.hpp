...
public:
 ...
 the animation, the start X frame, the Start Y frame, the End X frame, the End Y Frame, the width of the Frame(s), the height of the Frame(s)
    ...
    //Accessors
     ...
     [[nodiscard]] const int& getStartX(int index) const;
     [[nodiscard]] const int& getStartY(int index) const;
     [[nodiscard]] const int& getEndX(int index) const;
     [[nodiscard]] const int& getEndY(int index) const;
