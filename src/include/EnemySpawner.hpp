...
public:
    ...
    EnemySpawner(float x, float y, sf::Vector2f gridsize_f, sf::Texture& texture, const sf::IntRect& texturerect, int type, int amount, std::int32_t time_to_spawn, float max_distance);
    ...
    const std::int32_t& getTime() const;
    // Functions
