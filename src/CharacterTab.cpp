    ...
    : Tab(vm, font, player, false)
{
    ...
    this->characterTabBack.setSize(sf::Vector2f(GUI::pixelpercentX(30.f, this->vm), static_cast<float>(this->vm.size.y)));
    // Text
    this->CharacterInfo = new sf::Text(font);
    ...
    this->CharacterInfo->setPosition(sf::Vector2f(this->characterTabBack.getPosition().x + GUI::pixelpercentX(1, this->vm), this->characterTabBack.getPosition().y + 20.f));
}
